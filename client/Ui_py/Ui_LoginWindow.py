...
from qfluentwidgets import BodyLabel, HyperlinkButton, LineEdit, PrimaryPushButton,MessageBox
import Ui_py.resource_rc

class Ui_Form(object):
    def setupUi(self, Form):
        self.Form = Form  # 保存 Form 实例
...
"}")
    ...
    def retranslateUi(self, Form):
        ...
        self.pushButton_2.setText(_translate("Form", "没有账号？点击注册"))

    def login(self):
        from function.login_register import login  # 在方法内部导入
